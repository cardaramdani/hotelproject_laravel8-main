...
Route::get('/profile/{user}', [App\Http\Controllers\HomeController::class, 'profile'])->middleware('auth')->name('profile');
Route::patch('/profile/edit/{user}', [App\Http\Controllers\HomeController::class, 'updateprofile'])->middleware('auth')->name('updateprofile');
